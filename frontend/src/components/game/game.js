...
class Game extends React.Component {
    ...
    componentDidMount() {
      document.title = "TYPING MASTER | Game";
    ...
    detectKeyPresses(e) {
      ...
      if (this.state.countdown === 0){
          ...
          if (this.state.typedEntries === 0){
            this.setState( { interval: setInterval(this.incrementTime, 10), timeElapsed: 60, });
          }
  ...
  checkInput() {
      console.log("Checking input", this.state.phrase, 'timeeeeee', this.state.gameWon)
